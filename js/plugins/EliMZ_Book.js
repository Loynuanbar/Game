...
@plugindesc ♦5.4.18♦ Essential plugin for all Eli plugins.
...
Eli.Utils = {
     ...
     * 
     * @returns {number>}
     * @deprecated Must be replaced with calculatePosition
     */
    ...
    getMapCharacter(id){
        if(id == 0){
            ...
            if(newId === "camera"){
                ...
                return $gameMap.vehicles().find(item => (item?.getSpriteId() || "").toLowerCase() === newId)
            }
        }
    },
